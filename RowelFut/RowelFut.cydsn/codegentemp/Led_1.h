...
/* Interrupt Registers */
	...
	#define Led_1_1_INTTYPE_REG 		(* (reg8 *) Led_1__1__INTTYPE)
	#define Led_1_2_INTTYPE_REG 		(* (reg8 *) Led_1__2__INTTYPE)
	#define Led_1_3_INTTYPE_REG 		(* (reg8 *) Led_1__3__INTTYPE)
#endif /* (Led_1__INTSTAT) */
