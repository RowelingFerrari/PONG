...
*
* \funcusage
*  \snippet DIR1_SUT.c usage_DIR1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet DIR1_SUT.c usage_DIR1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet DIR1_SUT.c usage_DIR1_Read  
*******************************************************************************/
...
* preferred DIR1_Read() API because the 
* DIR1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet DIR1_SUT.c usage_DIR1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: DIR1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use DIR1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - DIR1_0_INTR       (First pin in the list)
    *  - DIR1_1_INTR       (Second pin in the list)
    *  - ...
    *  - DIR1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet DIR1_SUT.c usage_DIR1_SetInterruptMode
    *******************************************************************************/
    void DIR1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & DIR1_0_INTR) != 0u) 
		{ 
			 DIR1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet DIR1_SUT.c usage_DIR1_ClearInterrupt
    *******************************************************************************/
