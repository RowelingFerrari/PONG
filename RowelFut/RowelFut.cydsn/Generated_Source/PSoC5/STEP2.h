...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the STEP2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(STEP2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in STEP2_SetInterruptMode() function.
     *  @{
     */
        #define STEP2_INTR_NONE      (uint16)(0x0000u)
        #define STEP2_INTR_RISING    (uint16)(0x0001u)
        #define STEP2_INTR_FALLING   (uint16)(0x0002u)
        #define STEP2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define STEP2_INTR_MASK      (0x01u) 
#endif /* (STEP2__INTSTAT) */
...
/* SIO registers */
#if defined(STEP2__SIO_CFG)
    #define STEP2_SIO_HYST_EN        (* (reg8 *) STEP2__SIO_HYST_EN)
    #define STEP2_SIO_REG_HIFREQ     (* (reg8 *) STEP2__SIO_REG_HIFREQ)
    #define STEP2_SIO_CFG            (* (reg8 *) STEP2__SIO_CFG)
    #define STEP2_SIO_DIFF           (* (reg8 *) STEP2__SIO_DIFF)
#endif /* (STEP2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define STEP2_0_INTTYPE_REG 		(* (reg8 *) STEP2__0__INTTYPE)
#endif /* (STEP2__INTSTAT) */
