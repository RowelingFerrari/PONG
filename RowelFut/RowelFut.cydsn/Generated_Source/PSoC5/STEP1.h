...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the STEP1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(STEP1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in STEP1_SetInterruptMode() function.
     *  @{
     */
        #define STEP1_INTR_NONE      (uint16)(0x0000u)
        #define STEP1_INTR_RISING    (uint16)(0x0001u)
        #define STEP1_INTR_FALLING   (uint16)(0x0002u)
        #define STEP1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define STEP1_INTR_MASK      (0x01u) 
#endif /* (STEP1__INTSTAT) */
...
/* SIO registers */
#if defined(STEP1__SIO_CFG)
    #define STEP1_SIO_HYST_EN        (* (reg8 *) STEP1__SIO_HYST_EN)
    #define STEP1_SIO_REG_HIFREQ     (* (reg8 *) STEP1__SIO_REG_HIFREQ)
    #define STEP1_SIO_CFG            (* (reg8 *) STEP1__SIO_CFG)
    #define STEP1_SIO_DIFF           (* (reg8 *) STEP1__SIO_DIFF)
#endif /* (STEP1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define STEP1_0_INTTYPE_REG 		(* (reg8 *) STEP1__0__INTTYPE)
#endif /* (STEP1__INTSTAT) */
